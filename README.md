# kherbache-thesis
This repository aims to provide all the needed informations to reproduce the experiments presented on the thesis of Vincent KHERBACHE.

Before fully integrating our new network model, heuristic, energy objective, etc., the new version of BtrPlace was called 'mVM'.
In this documentation, the term 'mVM' refers to the new version BtrPlace as described in the thesis.
...
## Build SimGrid and dependencies

Get simdiff from git@github.com:btrplace/simdiff.git
...
cd simgrid
# Checkout the correct version 3.13  (01/01/16)
...
```
./migrate_vm topology.xml output_file.txt test_from_2_to_0.json
```
