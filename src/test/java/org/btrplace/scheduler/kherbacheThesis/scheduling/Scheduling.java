package org.btrplace.scheduler.kherbacheThesis.scheduling;
...
public class Scheduling {
    ...
    String path = new File("").getAbsolutePath() + "/src/test/java/org/btrplace/scheduler/kherbacheThesis/scheduling/";
